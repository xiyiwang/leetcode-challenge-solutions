"""
LeetCode Challenge: Partitioning Into Minimum Number Of Deci-Binary Numbers (2021-05-26)
...
class Solution:
    # one-liner: 36 ms - beats 96.80%
    def minPartitions(self, n: str) -> int:
        return int(sorted(set(n))[-1])

n1 = "32" # 3
n2 = "82734" # 8
n3 = "27346209830709182346" # 9